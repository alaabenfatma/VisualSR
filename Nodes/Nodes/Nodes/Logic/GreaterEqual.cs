...
namespace Nodes.Nodes.Logic
{
...

    {
        ...
        public GreaterEqual([Import("host")] VirtualControl host,
            [Import("bool")] bool spontaneousAddition = false) : base(host, NodeTypes.Basic, spontaneousAddition)
        {
            Title = ">=";
        ...
        {
            var node = new GreaterEqual(Host, false);
